...
888    888                                             888      88P         
888    888                                             888      8P          
8888888888  8888b.  88888b.   .d8888b .d88b.   .d8888b 888  888 "  .d8888b  
888    888     "88b 888 "88b d88P"   d88""88b d88P"    888 .88P    88K      
888    888 .d888888 888  888 888     888  888 888      888888K     "Y8888b. 
888    888 888  888 888  888 Y88b.   Y88..88P Y88b.    888 "88b         X88 
888    888 "Y888888 888  888  "Y8888P "Y88P"   "Y8888P 888  888     88888P' 
                                                                            
                                                                            
                                                                            
888    888          888  .d888      888    888                              
888    888          888 d88P"       888    888                              
888    888          888 888         888    888                              
8888888888  8888b.  888 888888      8888888888  .d88b.  888  888 888d888    
888    888     "88b 888 888         888    888 d88""88b 888  888 888P"      
888    888 .d888888 888 888         888    888 888  888 888  888 888        
888    888 888  888 888 888         888    888 Y88..88P Y88b 888 888        
888    888 "Y888888 888 888         888    888  "Y88P"   "Y88888 888        
...
record _|>_ (I O : Set) : Set1 where
  ...
  field
    Comm : (o : O) -> Set
    Resp : (o : O)(c : Comm o) -> Set
    next : (o : O)(c : Comm o)(r : Resp o c) -> I
open _|>_
infixl 2 _|>_
...
_=<<_ : forall {I}{F : I |> I}{P Q} ->         [ P -:> FIx F Q ]
                                    ->   [ FIx F P -:> FIx F Q ]
k =<< return p  = k p
k =<< (! c , j) = ! c , \ r -> k =<< j r
...
_=<<Co_ : forall {I}{F : I |> I}{P Q} ->           [ P -:> CoFIx F Q ]
                                      ->   [ CoFIx F P -:> CoFIx F Q ]
...
footle : forall {I}(F : I |> I){P Q : Ix I} ->    [ P -:> Q +: F $ P ]
                                            ->    [ P -:> CoFIx F Q ]
...
fordOut : forall {I}{Q : Ix I} -> [ SgSyncR _==_ Q -:> Q ]
fordOut (_ , q , refl) = q
...
fordDriveCo Hi Lo D t =
  (retCo - fordOut) =<<Co driveCo _==_ Hi Lo D (fordIn t)
...
peterHan : forall {I} (C : I |> I) (o : I) (t : FIx C (ko One) o) ->
           Responses C t -> I
peterHan C o (return x) <>       = o
peterHan C o (! c , k)  (r , rs) = peterHan C (next C o c r) (k r) rs

Star : forall {I} -> I |> I -> I |> I
Comm (Star C) = FIx C (ko One)
Resp (Star C) o = Responses C
next (Star C) = peterHan C
